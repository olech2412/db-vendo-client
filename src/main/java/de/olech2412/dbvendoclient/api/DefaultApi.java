...
import de.olech2412.dbvendoclient.ApiClient;
import de.olech2412.dbvendoclient.BaseApi;
import de.olech2412.dbvendoclient.model.*;
import de.olech2412.dbvendoclient.requests.*;
...
public class DefaultApi extends BaseApi {
    ...
    public List<StopsIdGet2XXResponse> locationsNearbyGet(LocationsNearbyRequest locationsNearbyRequest) throws RestClientException {
        return locationsNearbyGetWithHttpInfo(locationsNearbyRequest.getLocation(), locationsNearbyRequest.getResults(), locationsNearbyRequest.getDistance(), locationsNearbyRequest.isStops(), locationsNearbyRequest.isPoi(), locationsNearbyRequest.isLinesOfStops(), locationsNearbyRequest.getLanguage()).getBody();
    }
     ...
     * @param language  Language of the results. (optional, default to en)
     * @param pretty    Pretty-print JSON responses? (optional)
