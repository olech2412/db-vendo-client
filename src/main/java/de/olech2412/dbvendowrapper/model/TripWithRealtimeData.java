 ...
 */
@JsonPropertyOrder({
        TripWithRealtimeData.JSON_PROPERTY_TRIP,
        TripWithRealtimeData.JSON_PROPERTY_REALTIME_DATA_UPDATED_AT
})
...
public class TripWithRealtimeData {
    ...
    public TripWithRealtimeData() {
    }

    public TripWithRealtimeData trip(@jakarta.annotation.Nullable Trip trip) {
    ...
    @JsonProperty(JSON_PROPERTY_TRIP)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTrip(@jakarta.annotation.Nullable Trip trip) {
        this.trip = trip;
    }

    public TripWithRealtimeData realtimeDataUpdatedAt(@jakarta.annotation.Nullable BigDecimal realtimeDataUpdatedAt) {
    ...
    public boolean equals(Object o) {
        ...
        TripWithRealtimeData tripWithRealtimeData = (TripWithRealtimeData) o;
        return Objects.equals(this.trip, tripWithRealtimeData.trip) &&
                Objects.equals(this.realtimeDataUpdatedAt, tripWithRealtimeData.realtimeDataUpdatedAt);
    }
    ...
    public String toString() {
        String sb = "class TripWithRealtimeData {\n" +
