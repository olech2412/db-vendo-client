...
public class Edge {
    ...
    public Edge fromLocation(@jakarta.annotation.Nullable StopsIdResponse fromLocation) {
    ...
    public Edge toLocation(@jakarta.annotation.Nullable StopsIdResponse toLocation) {
