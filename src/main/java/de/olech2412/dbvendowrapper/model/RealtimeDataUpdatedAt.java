 ...
 */
@JsonPropertyOrder({
        RealtimeDataUpdatedAt.JSON_PROPERTY_REALTIME_DATA_UPDATED_AT
})
...
public class RealtimeDataUpdatedAt {
    ...
    public RealtimeDataUpdatedAt() {
    }

    public RealtimeDataUpdatedAt realtimeDataUpdatedAt(@jakarta.annotation.Nullable BigDecimal realtimeDataUpdatedAt) {
    ...
    public boolean equals(Object o) {
        ...
        RealtimeDataUpdatedAt realtimeDataUpdatedAt = (RealtimeDataUpdatedAt) o;
        return Objects.equals(this.realtimeDataUpdatedAt, realtimeDataUpdatedAt.realtimeDataUpdatedAt);
    }

    @Override
    public int hashCode() {
        return Objects.hash(realtimeDataUpdatedAt);
    }

    @Override
    public String toString() {
        String sb = "class RealtimeDataUpdatedAt {\n" +
